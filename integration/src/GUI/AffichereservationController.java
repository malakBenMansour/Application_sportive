...
private ObservableList<Reservation> masterData = FXCollections.observableArrayList();
    @FXML
    private TableColumn<Reservation, Integer> txtidf;
    @FXML
    private Button exit;
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
         ...
         List <Reservation> l=p.afficherF();
         
         data=FXCollections.observableArrayList(l);
       
       txtidr.setCellValueFactory(new PropertyValueFactory <Reservation,Integer>("idf"));
