 ...
 * @author dell
 */
public class Edit_recController implements Initializable {
...
/**
 ...
 if(verif()){
  ...
  String num_c=tfNum.getText();
    ...
    rs.modifier(id_rec, r);
     Notifications notificationBuilder=Notifications.create()
              .title("Succées").text("  Réclamation Modifiée ").graphic(null).hideAfter(javafx.util.Duration.seconds(5))
    ...
    String htmlCode = "<h1> Bonjour M/Mme "+pers[1]+",   </h1> <br/> <h2><b>Votre réclamation << "+titre+" >> envoyé le "+date_ajout+" est "+etat+". </b></h2> <br/> <h3><b>Notre équipe vous remercie pour votre confiance. </b></h3><br/> <h3><b>Cordialement,<br> Connect Sport </b></h3>";
   ...
   FXMLLoader loader= new FXMLLoader(getClass().getResource("Afficher_rec.fxml"));
    ...
    public void charger_rec(){
    comboEtat.setDisable(false);
        Reclamation r =rs.afficher_recbyid(id_rec);
    tfTitre.setText(r.getTitre());
    tfDescription.setText(r.getDescription());
    LocalDate date = Date.valueOf(r.getDate_ajout().toString()).toLocalDate();
    tfNum.setText(r.getNum_commande());
tfDate.setValue(date);
    p=Userconnected.getId();
    comboEtat.setValue(r.getEtat());
    comboCat.setValue(r.getCategorie());
