 ...
 * @author dell
 */
public class Add_rec_fanController implements Initializable {
...
//int p=1;
  ...
  int cat=cs.id_categF(comboCat.getSelectionModel().getSelectedItem());
  ...
  /* FXMLLoader loader= new FXMLLoader(getClass().getResource("actfan.fxml"));
       ...
       Parent root = (Parent)loader.load();
        ...
        ActfanController ap= loader.getController();*/
  FXMLLoader loader= new FXMLLoader(getClass().getResource("Afficher_recfan.fxml"));
    ...
    void charge_cat()
    {
        comboCat.getItems().clear();//vider
         List<String> le=cs.afficher_catF();
